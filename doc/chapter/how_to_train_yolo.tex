...
\begin{enumerate}
    ...
    \end{enumerate}
    \item Dockercontainer installieren $\rightarrow$ wenn \ac{yolo}v5 bitte unten den Anweisungen folgen
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item wenn der Container nicht die GPU nutzen soll, muss die Flag: \textit{--gpus all} weggelassen werden
    \end{itemize}
